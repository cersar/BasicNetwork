...
from network.InceptionModule import InceptionModule_V1,aux_classifier
...
def InceptionV1(input_shape):
    ...
    with net.as_default():
        ...
        inception_blok1 = InceptionModule_V1(pool2,64,96,128,16,32,32)
        inception_blok2 = InceptionModule_V1(inception_blok1, 128, 128, 192, 32, 96, 64)
        pool3 = tf.layers.max_pooling2d(inception_blok2, (3, 3), (2, 2), padding='same')

        inception_blok3 = InceptionModule_V1(pool3, 192, 96, 208, 16, 48, 64)

        inception_blok4 = InceptionModule_V1(inception_blok3, 160, 112, 224, 24, 64, 64)
        inception_blok5 = InceptionModule_V1(inception_blok4, 128, 128, 256, 24, 64, 64)
        inception_blok6 = InceptionModule_V1(inception_blok5, 112, 144, 288, 32, 64, 64)

        inception_blok7 = InceptionModule_V1(inception_blok6, 256, 160, 320, 32, 128, 128)
        pool4 = tf.layers.max_pooling2d(inception_blok7, (3, 3), (2, 2), padding='same')

        inception_blok8 = InceptionModule_V1(pool4, 256, 160, 320, 32, 128, 128)
        inception_blok9 = InceptionModule_V1(inception_blok8, 384, 192, 384, 48, 128, 128)
